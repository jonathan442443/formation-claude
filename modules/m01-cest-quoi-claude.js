export default {partie:0,num:1,locked:false,titre:"C'est quoi Claude exactement ?",sub:"Démystifier l'IA sans jargon. Forces, limites, et les 3 modèles.",duree:"25 min",niv:"Débutant",
sections:[
...
<p class="block-text">Ce module t'explique comment il fonctionne vraiment, ses forces, ses limites, et comment bien l'utiliser. Parce que bien utiliser un outil, ça commence par le comprendre.</p>`},
...
<li>4. Sur le plan gratuit, tu as accès aux 3 modèles : Haiku, Sonnet et Opus.</li>
<li>5. Si Claude met du temps à répondre, c'est qu'il "réfléchit plus", donc la réponse sera meilleure.</li></ul>
<p style="margin-top:10px;"><strong>Réponses :</strong> 1-Faux (il construit ses réponses mot par mot) | 2-Faux (hallucinations possibles, vérifie toujours) | 3-Vrai | 4-Faux (Opus est réservé au plan Pro, en gratuit tu as Haiku et Sonnet) | 5-Faux (la vitesse dépend du modèle choisi, pas de la qualité, Sonnet donne d'excellents résultats en quelques secondes)</p></div>
